...
namespace FreelancerDirectoryAPI.Infrastructure.Services.Handlers
{
    public class HttpClientHandler : IHttpClientHandler
    {
        ...
        public async Task<ServiceResult<TResult>> GenericRequestWithAuthorization<TRequest, TResult>(string clientApi, string url, string token, CancellationToken cancellationToken, MethodType method = MethodType.Get, TRequest requestEntity = null, string authorizationHeaderName = "Authorization")
            where TRequest : class
            where TResult : class
        {
            var httpClient = _httpClientFactory.CreateClient(clientApi);

            httpClient.DefaultRequestHeaders.Add(authorizationHeaderName, token);
